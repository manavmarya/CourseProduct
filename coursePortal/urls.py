"""coursePortal URL Configuration
...
urlpatterns = [
    ...
    url(r'^password_reset/$', auth_views.PasswordResetView.as_view(template_name='password_reset')),
    url(r'^password_reset/done/$', auth_views.PasswordChangeDoneView.as_view(template_name="password_reset_done.html",email_template_name='password_reset_email.html')),
